export type { Denops } from "https://deno.land/x/denops_std@v2.2.0/mod.ts#^";
export { execute } from "https://deno.land/x/denops_std@v2.2.0/helper/mod.ts#^";
export {
  batch,
  gather,
} from "https://deno.land/x/denops_std@v2.2.0/batch/mod.ts#^";
export * as op from "https://deno.land/x/denops_std@v2.2.0/option/mod.ts#^";
export * as fn from "https://deno.land/x/denops_std@v2.2.0/function/mod.ts#^";
