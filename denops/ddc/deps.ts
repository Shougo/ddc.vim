export type { Denops } from "https://deno.land/x/denops_std@v1.0.0-alpha.0/mod.ts";
...
export * as autocmd from "https://deno.land/x/denops_std@v1.0.0-alpha.0/autocmd/mod.ts";
